...
\noindent\fbox{
    \parbox{\textwidth}{
        \null\hfill \textbf{Soluzione:} $T=1h:36min $\\
        \textbf{Procedimento: } \\
        Il raggio dell'orbita di HST è pari a:\\
        $r_{orb}=r_{terra} + d_{satellite}=6378km + 600km= 6978km=6978000m$\\ \\
        Sapendo che:
        \begin{gather*}
            v_c=\sqrt{\frac{G \cdot M_T}{r}} \qquad T=\frac{2\cdot \pi \cdot r }{v_c}\\
            v_c=\sqrt{\frac{6.67\cdot 10^{-11}Nm^2/kg^2\cdot 5.98\cdot 10^{25}kg}{6978000m}}=\sqrt{57 160 504}=7560.45m/s\\
            T=\frac{2\cdot \pi \cdot 6978000m }{7560.45m/s}=5.799.13s\\
            1h:36min
        \end{gather*}
